      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-sm">
              WeMakeScholars is a Not-just-for-Profit organization and India's
        ...
        <div className="border-t border-gray-700 pt-4 text-sm">
          <p>
            All Content, Logo, Company names and any other subject of
            intellectual property are registered trademarks of their respective
            owners. Display of such intellectual property on WeMakeScholars.com
