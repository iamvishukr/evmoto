...
export default function SearchForm() {
          ...
          {dropdownOptions[name].map((option) => (
            <label key={option} className="flex items-center px-4 py-2 hover:bg-gray-100 cursor-pointer">
              <input
                ...
                name={name}
                value={option}
                checked={isMultiple ? formData[name].includes(option) : formData[name] === option}
  ...
  return (
    <div className="min-h-screen w-full flex flex-col bg-gray-100 -mt-40">
            ...
            <div className="flex mb-0 h-20">
              <button
                className={`flex-1 flex-col py-4 px-6 flex items-center justify-center ${
                  activeTab === "scholarships" ? "bg-teal-500 text-white" : "bg-white text-gray-700"
                }`}
              ...
              <button
                className={`flex-1 flex-col  py-4 px-6 flex items-center justify-center ${
                  activeTab === "loans" ? "bg-teal-500 text-white" : "bg-white hover:bg-teal-500 text-gray-700 hover:text-white"
                }`}
